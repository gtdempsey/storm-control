...
# Form implementation generated from reading ui file 'qstate-misc.ui'
#
# Created: Wed Feb 26 13:30:56 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QtCore.QSize(512, 112))
        Dialog.setMaximumSize(QtCore.QSize(512, 112))
        Dialog.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.okButton = QtGui.QPushButton(Dialog)
        self.okButton.setGeometry(QtCore.QRect(430, 70, 75, 24))
        ...
        self.filter7Button = QtGui.QPushButton(self.filterWheelGroupBox)
        self.filter7Button.setGeometry(QtCore.QRect(371, 20, 51, 24))
        self.filter7Button.setCheckable(True)
        self.filter7Button.setAutoExclusive(True)
        self.filter7Button.setObjectName(_fromUtf8("filter7Button"))
        self.filter8Button = QtGui.QPushButton(self.filterWheelGroupBox)
        ...
        self.filter8Button.setObjectName(_fromUtf8("filter8Button"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.filter7Button.setText(_translate("Dialog", "7", None))
        self.filter8Button.setText(_translate("Dialog", "8", None))
